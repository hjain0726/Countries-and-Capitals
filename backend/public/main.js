...
/* harmony import */ var _firstpage_firstpage_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./firstpage/firstpage.component */ "./src/app/firstpage/firstpage.component.ts");
...
var appRoutes = [
    { path: 'welcome', component: _firstpage_firstpage_component__WEBPACK_IMPORTED_MODULE_4__["FirstpageComponent"] },
    { path: 'listing', component: _countries_countries_component__WEBPACK_IMPORTED_MODULE_3__["CountriesComponent"] },
...
/* harmony import */ var _firstpage_firstpage_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./firstpage/firstpage.component */ "./src/app/firstpage/firstpage.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _countries_countries_component__WEBPACK_IMPORTED_MODULE_9__["CountriesComponent"],
                _firstpage_firstpage_component__WEBPACK_IMPORTED_MODULE_10__["FirstpageComponent"],
...
var CountriesComponent = /** @class */ (function () {
    function CountriesComponent(apiService, router) {
        this.apiService = apiService;
        this.router = router;
    }
    CountriesComponent.prototype.edit = function (country) {
        this.apiService.setCountry(country);
        this.router.navigate(['/edit']);
    };
    CountriesComponent.prototype.delete = function (id) {
        var _this = this;
        this.apiService.deletedata(id).subscribe(function (res) {
            console.log(res);
            _this.initialize();
        });
    };
    CountriesComponent.prototype.initialize = function () {
        var _this = this;
    ...
    CountriesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], CountriesComponent);
...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(apiService, router) {
        this.apiService = apiService;
        this.router = router;
    }
    CreateComponent.prototype.create = function () {
        var _this = this;
        this.apiService.saveData(this.createform.value).subscribe(function (res) {
            _this.res = res['msg'];
    ...
    ], CreateComponent.prototype, "createform", void 0);
    CreateComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], CreateComponent);
...
var EditComponent = /** @class */ (function () {
    function EditComponent(apiService, router) {
        this.apiService = apiService;
        this.router = router;
    }
    EditComponent.prototype.edit = function () {
        var _this = this;
        this.apiService.editData(this.apiService.country._id, this.editForm.value).subscribe(function (res) {
            console.log(res);
            _this.router.navigate(['/listing']);
        });
    };
    ...
    EditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], EditComponent);
...
module.exports = "<h1>Welcome to Countries and Capitals</h1>\n"
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.setCountry = function (country) {
...
module.exports = __webpack_require__(/*! C:\Users\hp\Desktop\practice-crud\frontend\src\main.ts */"./src/main.ts");
